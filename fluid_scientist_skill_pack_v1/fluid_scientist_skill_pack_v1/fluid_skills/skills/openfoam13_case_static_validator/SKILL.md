# openfoam13.case.static_validator

## 目的

检查 Foundation 13 文件结构、solver module 和安全关键字。
...
`fluid_skills.runtime.openfoam13:static_validate_case`

## 依赖

openfoam13.platform.discovery
